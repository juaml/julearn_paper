...
out_path = Path(__file__).parent.parent / "results" / "3_gf"
...
logger.info(f"Saving scores to: {out_path / scores_out_fname}")
logger.info(f"Saving predictions to: {out_path / preds_out_fname}")
